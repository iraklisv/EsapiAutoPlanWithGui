    ...
    public class Breast
    {
            ...
            )
        {
            ...
            if (hasLSide)
            {
                ...
                {
                    if (L_ptvSupra == null)
                        L_med0 = eps.AddMLCBeam(machinePars, null, BeamHelpers.defaultJawPositions, L_SelectedMedColAngle, L_SelectedMedGantryAngle, 0, L_isocenter); // if no supra, use col angle
                    else
                        L_med0 = eps.AddMLCBeam(machinePars, null, BeamHelpers.defaultJawPositions, 0, L_SelectedMedGantryAngle, 0, L_isocenter); // if supra, col angle = 0
                }
                else
                {
                    ...
                    if (L_ptvSupra == null)
                    {
                        ...
                        var optimalGantryAngle = BeamHelpers.findBreastOptimalGantryAngleForMedialField(machinePars, eps, ss, L_ptvBreast, L_LungIpsi, L_isocenter, "Left"); // get optimal angle
                                                                                                                                                                             // get optimal collimator rotation for optimal angle, use beam's eye view for dat
                        var ColAndJaw = BeamHelpers.findBreastOptimalCollAndJawIntoLung(machinePars, eps, L_isocenter, ss, L_ptvBreast, L_LungIpsi, optimalGantryAngle, medstartCA, medendCA, stepCA, "Left", true); // get optimal angle
                        L_med0 = eps.AddMLCBeam(machinePars, null, BeamHelpers.defaultJawPositions, ColAndJaw.Item1, optimalGantryAngle, 0, L_isocenter);
                    }
                    else
                    {
                        var optimalAngle = BeamHelpers.findBreastOptimalGantryAngleForMedialField(machinePars, eps, ss, L_ptvBreast, L_LungIpsi, L_isocenter, "Left");
                        L_med0 = eps.AddMLCBeam(machinePars, null, BeamHelpers.defaultJawPositions, 0, optimalAngle, 0, L_isocenter); // if supra, col angle = 0, that's it
                    }
                }
            }
            if (hasRSide)
            {
                ...
                {
                    if (R_ptvSupra == null)
                        R_med0 = eps.AddMLCBeam(machinePars, null, BeamHelpers.defaultJawPositions, R_SelectedMedColAngle, R_SelectedMedGantryAngle, 0, R_isocenter); // if no supra, use col angle
                    else
                        R_med0 = eps.AddMLCBeam(machinePars, null, BeamHelpers.defaultJawPositions, 0, R_SelectedMedGantryAngle, 0, R_isocenter); // if supra, col angle = 0
                }
                else
                {
                    // try to find optimale angle
                    ...
                    {
                        // get optimal gantry angle
                        var optimalGantryAngle = BeamHelpers.findBreastOptimalGantryAngleForMedialField(machinePars, eps, ss, R_ptvBreast, R_LungIpsi, R_isocenter, "Right"); // get optimal angle
                                                                                                                                                                              // get optimal collimator rotation for optimal angle, use beam's eye view for dat
                        var ColAndJaw = BeamHelpers.findBreastOptimalCollAndJawIntoLung(machinePars, eps, R_isocenter, ss, R_ptvBreast, R_LungIpsi, optimalGantryAngle, medstartCA, medendCA, stepCA, "Left", true); // get optimal angle
                        R_med0 = eps.AddMLCBeam(machinePars, null, BeamHelpers.defaultJawPositions, ColAndJaw.Item1, optimalGantryAngle, 0, R_isocenter);
                    }
                    else
                    {
                        var optimalAngle = BeamHelpers.findBreastOptimalGantryAngleForMedialField(machinePars, eps, ss, R_ptvBreast, R_LungIpsi, R_isocenter, "Right");
                        R_med0 = eps.AddMLCBeam(machinePars, null, BeamHelpers.defaultJawPositions, 0, optimalAngle, 0, R_isocenter); // if supra, col angle = 0, that's it
                    }
                }
            }
            if (hasLSide)
            ...
            )
        {
            ...
            //machinePars = new ExternalBeamMachineParameters(machinePars.MachineId, "6X", 1400, "STATIC", "FFF"); 
            Beam L_med0 = null;
            Beam L_med20 = null;
            Beam L_med40 = null;
            Beam L_lat0 = null;
            ...
            )
        {
            ...
            // prepare fields and stuff
            //machinePars = new ExternalBeamMachineParameters(machinePars.MachineId, "6X", 1400, "ARC", "FFF"); // for fif manually change energy to 6x/dr600, static!
            if (machinePars.TechniqueId != "ARC")
            {
            ...
            if (hasLSide)
            {
                ...
                if (L_ptvSupra != null)
                {
                    ...
                    var stStopAngle = 160;
                    L_arc5 = eps.AddArcBeam(machinePars, new VRect<double>(-50, -50, 50, 50),
            ...
            if (hasRSide)
            {
                ...
                if (R_ptvSupra != null)
                {
                    ...
                    var stStopAngle = 200;
                    R_arc5 = eps.AddArcBeam(machinePars, new VRect<double>(-50, -50, 50, 50),
