...
namespace SimpleGui.AutoPlans
{
    public class GynecologyScript
    {
        ...
        public void runGynecologyScript(Patient pat, ExternalPlanSetup eps1, StructureSet ss1,
            ...
            string rectumId, string bladderId, string bowelId, string femorLid, string femorRid)
        {
            ...
            StructureHelpers.CopyStructureInBounds(RectumCropped, Rectum, ss.Image, (PTVe.MeshGeometry.Bounds.Z - 10, PTVe.MeshGeometry.Bounds.Z + PTVe.MeshGeometry.Bounds.SizeZ + 10));
            ...
            RectumMinusPTV.SegmentVolume = RectumCropped.Sub(PTVe3mm);
            BladderMinusPTV.SegmentVolume = Bladder.Sub(PTVe3mm);
            BowelMinusPTV.SegmentVolume = BowelBag.Sub(PTVe3mm);
            // create rings
            ...
            // rectum
            BeamHelpers.SetOptimizationUpperObjectiveInGy(optSetup, RectumCropped, maxPrescribed * (30D / 54D), 060, 00);
            BeamHelpers.SetOptimizationUpperObjectiveInGy(optSetup, RectumCropped, maxPrescribed * 1.01D, 000, 70);
            BeamHelpers.SetOptimizationUpperObjectiveInGy(optSetup, RectumMinusPTV, maxPrescribed * (30D / 54D), 030, 70);
