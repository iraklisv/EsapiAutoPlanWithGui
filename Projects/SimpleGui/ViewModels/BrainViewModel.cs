...
namespace SimpleGui.ViewModels
{
    public class BrainViewModel : ViewModelBase
    {
        ...
        public BrainViewModel(MainViewModel main)
        {
            ...
            SelectedLensL = ListOfOARs.FirstOrDefault(x => x.Equals("LensL"));
            SelectedLensR = ListOfOARs.FirstOrDefault(x => x.Equals("LensR"));
            SelectedHippoL = ListOfOARs.FirstOrDefault(x => x.Equals("HippoCL"));
            SelectedHippoR = ListOfOARs.FirstOrDefault(x => x.Equals("HippoCR"));
